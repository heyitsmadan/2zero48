...
class Board {
  ...
  getNextRandom() {
    var rng = seedrandom(this.seed + this.rngState);
    this.rngState++;
    return rng();
  }
  ...
  addRandomTile() {
    ...
    var index = Math.floor(this.getNextRandom() * emptyCells.length);
    var cell = emptyCells[index];
    var newValue = this.getNextRandom() < this.fourProbability ? 4 : 2;
    this.score += newValue;
